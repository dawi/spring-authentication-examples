...
public final class CertificateUtils {
    ...
    public static Saml2X509Credential getSigningCredential(Resource privateKeyLocation, Resource certificateLocation) {
        return signing(
            readPrivateKey(privateKeyLocation),
            readCertificate(certificateLocation)
        );
    }

    public static Saml2X509Credential getEncryptionCredential(Resource privateKeyLocation, Resource certificateLocation) {
        return decryption(
            readPrivateKey(privateKeyLocation),
            readCertificate(certificateLocation)
        );
